...
def main():
    ...
    test_dataset = torchvision.datasets.ImageFolder('../../dataset/val', transform=test_transform)
    ...
    fe = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/resnet50/indv/checkpoints/TI_RNET_INDV_fe.pth', map_location='cpu')
    classifier = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/resnet50/indv/checkpoints/TI_RNET_INDV_classifier.pth', map_location='cpu')
