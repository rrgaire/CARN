...
def main():
    ...
    fe = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/resnet50/indv/checkpoints/TI_RNET_INDV_fe.pth')

    resnet_1 = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/resnet50/indv/checkpoints/TI_RNET_INDV_classifier.pth')
    resnet_2 = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/resnet50/pruned_v2/checkpoints/TI_RNET_ratio_0.5_4_classifier.pth')
    resnet_3 = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/resnet50/pruned_v2/checkpoints/TI_RNET_ratio_0.9_3_classifier.pth')
