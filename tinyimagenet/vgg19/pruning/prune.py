...
def main():
    ...
    example_inputs = torch.randn(1, 128, 8, 8)
    example_inputs = example_inputs.to(args.device)

    fe = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/vgg19/indv/checkpoints/TI_VGG19_INDV_fe.pth', map_location='cpu')
    vgg19 = torch.load('/home/rrgaire/projects/iccv/paper/tinyimagenet/vgg19/indv/checkpoints/TI_VGG19_INDV_classifier.pth', map_location='cpu')
