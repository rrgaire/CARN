...
def main():
    ...
    fe = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/densenet121/indv/checkpoints/CIFAR100_DenseNet121_indv_fe.pth', map_location='cpu')
    densenet121_1 = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/densenet121/indv/checkpoints/CIFAR100_DenseNet121_indv_classifier.pth', map_location='cpu')
    densenet121_2 = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/densenet121/pruning_v2/checkpoints/C100_DNET_ratio_0.5_4_classifier.pth', map_location='cpu')
    densenet121_3 = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/densenet121/pruning_v2/checkpoints/C100_DNET_ratio_0.9_4_classifier.pth', map_location='cpu')
    ...
    test_dataset = CIFAR100WithSampler(
            args=args,
            model=task_model,
    ...
    train_dataset = CIFAR100WithSampler(
        args=args,
        model=task_model,
    ...
    val_dataset = CIFAR100WithSampler(
        args=args,
        model=task_model,
        transform=test_transform, 
        train=True
