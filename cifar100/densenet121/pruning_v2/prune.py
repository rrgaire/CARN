...
def main():
    ...
    classifier = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/densenet121/indv/checkpoints/CIFAR100_DenseNet121_indv_classifier.pth', map_location='cpu')
