...
def main():
    ...
    resnet50 = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/resnet50/indv/checkpoints/CIFAR100_ResNet50_indv_classifier.pth')
    fe.to('cpu')
    resnet50.to('cpu')
    log_msg = {}
    base_macs, base_nparams = tp.utils.count_ops_and_params(resnet50, example_inputs)
    log_msg['Base MACs'] = base_macs
    log_msg['Base Params'] = base_nparams
    # task_model = TaskModel(fe, resnet50, False)

    pruned_model = prune_model(args, resnet50, args.ratio, example_inputs)
