...
def main():
    ...
    fe = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/resnet50/indv/checkpoints/CIFAR100_ResNet50_indv_fe.pth', map_location='cpu')
    classifier = torch.load('/home/rrgaire/projects/iccv/paper/cifar100/resnet50/indv/checkpoints/CIFAR100_ResNet50_indv_classifier.pth', map_location='cpu')
