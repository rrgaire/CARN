...
def evaluate_task(args, sampler, task_model, loader, input):
    ...
    return accuracy, total_inference_time, total_flops, total_params, flops_sampler
...
def main():
    ...
    task_model = torch.load('/home/rrgaire/projects/iccv/paper/cifar10/resnet50/sampler/checkpoints/task_model.pth')
    task_model = task_model.to(args.device)

    sampler = Sampler(num_modules=3)
    sampler.load_state_dict(torch.load('/home/rrgaire/projects/iccv/paper/cifar10/resnet50/sampler/checkpoints/C10_RNET_RFC_sampler.pth'))
    ...
    task_accuracy, task_inference_time, task_flops, task_params, flops_sampler = evaluate_task(
            args=args,
            sampler=sampler,
