...
def get_args():
    ...
    parser.add_argument('--lambda_2', type=float, default=1.0, help='loss Weight lambda 1')
...
def main():
    ...
    resnet_1 = torch.load('/home/rrgaire/projects/iccv/paper/cifar10/resnet50/indv/checkpoints/resnet50_load_classifier.pth')
    resnet_2 = torch.load('/home/rrgaire/projects/iccv/paper/cifar10/resnet50/pruned_v2/checkpoints/C10_RNET_ratio_0.5_4_classifier.pth')
    resnet_3 = torch.load('/home/rrgaire/projects/iccv/paper/cifar10/resnet50/pruned_v2/checkpoints/C10_RNET_ratio_0.9_4_classifier.pth')

    task_model = TaskModel(fe, resnet_1, resnet_2, resnet_3, False)
