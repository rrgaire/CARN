...
def main():
    ...
    fe.load_state_dict(torch.load('../indv/checkpoints/resnet50_feature_extractor.pth'))
    resnet50 = ResNet50(num_classes=args.num_classes)
    resnet50.load_state_dict(torch.load('../indv/checkpoints/resnet50_classifier.pth'))
