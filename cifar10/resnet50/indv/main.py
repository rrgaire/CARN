...
def main():
    ...
    resnet50.load_state_dict(torch.load('/home/rrgaire/projects/iccv/expts/resnet50/indv/checkpoints/resnet50_classifier.pth'))
    ...
    torch.save(task_model.classifier, f'{args.name}_classifier.pth')
