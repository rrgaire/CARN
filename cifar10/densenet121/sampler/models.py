...
class CommonFE(nn.Module):
    def __init__(self, block, num_blocks, growth_rate=32, reduction=0.5):
        ...
        self.dense1 = self._make_dense_layers(block, num_planes, num_blocks)
...
class DenseNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.dense4(out)
        feat = F.avg_pool2d(F.relu(self.bn(out)), 4)
