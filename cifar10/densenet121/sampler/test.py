...
def main():
    ...
    task_model = torch.load('/home/rrgaire/projects/iccv/paper/cifar10/densenet121/sampler/checkpoints/task_model.pth')
    task_model = task_model.to(args.device)

    sampler = Sampler(num_modules=3)
    sampler.load_state_dict(torch.load('/home/rrgaire/projects/iccv/paper/cifar10/densenet121/sampler/checkpoints/C10_DNET_RFC__sampler.pth'))
