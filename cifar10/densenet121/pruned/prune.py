...
def main():
    ...
    fe = torch.load('/home/rrgaire/projects/iccv/expts/densenet121/indv/checkpoints/densenet121_fe.pth', map_location='cpu')
    densenet121 = torch.load('/home/rrgaire/projects/iccv/expts/densenet121/indv/checkpoints/densenet121_classifier.pth', map_location='cpu')
    ...
    # task_model = TaskModel(fe, resnet50, False)
